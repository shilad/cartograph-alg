...
​
      ...
      exp_dir=$(prepare_experiment_dir Media)
​
      for x in {0..3}
      do
...
​
          ...
          python -m study.data.ml_study_labels \
              --experiment ${exp_dir} \
              --articles_to_labels data/Media/${article_label_csv[$x]} \
              --label_names data/Media/${label_name_csv[$x]} \
