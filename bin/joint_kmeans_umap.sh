...
# Step 5: Run algorithmic steps that are necessary.
 ...
 python -m umap+kmeans.joint_umap_kmeans \
        ...
        --weight_high 10 \
        --weight_low 1 \
        --num_neighbors 20 >> ${exp_dir}/evaluation.json
...
python -m cartograph.json_generator data/food ${exp_dir} kk /country_labels.csv /cluster_groups.csv /xy_embeddings.csv /new_domain.json
...
python -m cartograph.evaluation.modularity_evaluator --experiment ${exp_dir} \
                                                     ...
                                                     --method nn \
                                                     --cluster_groups_csv ${exp_dir}/original_cluster_groups.csv >>${exp_dir}/evaluation.json
