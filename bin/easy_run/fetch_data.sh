...
num_of_articles=(20710 93811 353772)
...
#for i in {0..0}
#do
#  python -m beta.topic_finder data/education data/education \
#                                   50 /LDA_labels.csv /article_topic_distribution.csv
#
#  python -m beta.data.label_creator_lda data/education data/education/article_topic_distribution.csv \
#                                        data/education/labels/LDA_labels/LDA_labels.csv
#done
#
#for i in {1..1}
#do
