...
def get_top_labels(country_scores):
    ...
    print(top_labels, top_labels_pmi)


    return top_labels, top_labels_pmi


def main(experiment_dir, article_labels, percentile, label_score, use_label_candidates, num_candidates, purpose, label_source, output_file):
...
if __name__ == '__main__':
    ...
    main(args.experiment, article_labels, args.percentile, args.label_score, args.use_label_candidates, args.num_candidates, args.purpose, args.label_source, args.output_file)